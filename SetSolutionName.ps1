...
Rename-Item -path ([System.IO.Path]::Combine($SolutionFolder, 'Tailwind.SimpleBlazorWebAppTemplate.sln')) -newName ($NewSolutionName + '.sln')
Rename-Item -path ([System.IO.Path]::Combine($SolutionFolder, 'NewProjectTemplate\NewProjectTemplate.csproj')) -newName ($NewSolutionName + '.csproj')
Rename-Item -path ([System.IO.Path]::Combine($SolutionFolder, 'NewProjectTemplate\NewProjectTemplate.csproj.user')) -newName ($NewSolutionName + '.csproj.user')
